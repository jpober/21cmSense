...
class PrimaryBeam(metaclass=ABCMeta):
    ...
    @abstractproperty
    def width(self) -> un.radians:
        """Beam width [units: rad]."""
        pass

    @abstractproperty
    def first_null(self) -> un.radians:
        """An approximation of the first null of the beam."""
        pass

    @abstractproperty
    def sq_area(self) -> un.steradian:
        """The area of the beam^2."""
        pass

    @property
    def b_eff(self) -> un.steradian:
    ...
    @property
    def uv_resolution(self) -> 1 / un.radian:

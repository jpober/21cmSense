...
# VLA antenna (station) positions are given here in ECEF coordinate frame (Earth center earth fixed). 
with open('calibration_files/antpos_for_other_arrays/vla_antpos.csv') as f:
...
prms = {
    ...
    'loc': ('34:04:43', '-107:37:04'), #Socorro County, US
    'antpos': antpos,
    'beam': a.fit.Beam2DGaussian,
    'dish_size_in_lambda': 25.0 * (150.0*1e6) / (a.const.c*1e-2), #in units of wavelengths at 150 MHz; this will also define the observation duration for a drift scan.
